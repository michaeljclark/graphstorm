...
_cairo_filler_close (void *closure)
{
    ...
    /* close the subpath */
    return _cairo_filler_line_to (closure, &filler->last_move_to, NULL); /* XXX EMSCRIPTEN */
}
			...
			const cairo_point_t	*p3)
{
	...
	if (! _cairo_spline_intersects (&filler->current_point, p1, p2, p3,
					&filler->limit))
	    return _cairo_filler_line_to (filler, p3, NULL); /* XXX EMSCRIPTEN */
    }
    ...
    {
	return _cairo_filler_line_to (closure, p3, NULL); /* XXX EMSCRIPTEN */
    }
